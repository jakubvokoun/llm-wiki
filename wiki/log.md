...
- **queue (51):** tilt-product-faq, tilt-tutorial-overview, tilt-tutorial-1-prerequisites, tilt-tutorial-2-tilt-up, tilt-tutorial-3-tilt-ui, tilt-tutorial-4-code-update-repeat, tilt-tutorial-5-live-update, tilt-install, tilt-upgrade, tilt-snippets, tilt-editor-support, tilt-control-loop, tilt-choosing-clusters, tilt-local-vs-remote, tilt-faq, tilt-debug-faq, tilt-telemetry-faq, tilt-tiltfile-authoring, tilt-tiltfile-concepts, tilt-tiltfile-config, tilt-multiple-repos, tilt-file-changes, tilt-resource-dependencies, tilt-manual-update-control, tilt-disable-resources, tilt-example-static-html, tilt-example-go, tilt-example-python, tilt-example-nodejs, tilt-example-java, tilt-example-bazel, tilt-example-csharp, tilt-dependent-images, tilt-personal-registry, tilt-custom-build, tilt-integrating-bazel, tilt-skaffold, tilt-templating-yaml, tilt-helm, tilt-port-forwards, tilt-custom-resource, tilt-debuggers-python, tilt-local-resource, tilt-docker-compose, tilt-live-update-reference, tilt-ci, tilt-custom-buttons, tilt-extensions, tilt-contribute-extension, tilt-onboarding-checklist, tilt-snapshots
- **concepts:** tiltfile, tilt-control-loop, tilt-live-update, tilt-extensions
- **entities:** tilt
- **updated:** docker (Related Tools → tilt), kubernetes (Related Tools → tilt)
- **lint:** Issues found: 71 (56 orphans — new Tilt pages cross-linked only via [[wikilinks]], which lint doesn't count; 14 pages left unformatted when subagents were killed by a session limit before their prettier step; 1 dangling wikilink [[tilt-tutorial-3]]). Fixed: 71. Added a standard-markdown documentation map to entities/tilt.md linking all 51 sources + 4 concepts, plus inbound links to tilt.md from docker.md/kubernetes.md; prettier-reformatted the 14 pages; corrected [[tilt-tutorial-3]] → [[tilt-tutorial-3-tilt-ui]]. Result: 0 broken links, 0 orphans, 0 index drift, prettier --check clean. (3 decorative [[skaffold]]/[[helm]]/[[dockerfile]] wikilinks left as intentional "worth writing later" markers.)
- **query:** How to combine Tilt with Zarf / Helm for K8s deployments (inner vs outer loop; one shared Helm chart; hook gap; k8s_custom_deploy + manual zarf-package bridge patterns; image-ref alignment). Filed as: wiki/analyses/tilt-with-zarf-helm-deployments.md
