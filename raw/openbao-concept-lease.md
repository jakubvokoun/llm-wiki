---
source_url: https://openbao.org/docs/concepts/lease/
fetched: 2026-07-03
---
...
In addition to renewals, a lease can be *revoked*. When a lease is revoked, it
...
Along with the lease ID, a *lease duration* can be read. The lease duration is
...
[cli's lease revoke](/docs/commands/lease/revoke/)
command docs.
