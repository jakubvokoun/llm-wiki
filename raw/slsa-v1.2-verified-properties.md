...
with levels, levels may not be appropriate in all cases. Some software supply chain controls don't fit neatly
within existing SLSA levels. SLSA Verified Properties allows a common way to express those
...
Verification Summary Attestations (VSAs) when the VSA issuer determines the requirements have been met.
...
Source Track's two-party-review requirements.
...
build provenance from two or more independently operated Build Platforms which are
