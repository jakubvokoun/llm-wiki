...
The "what's broken" indicates the symptom; the "why" indicates a (possibly intermediate) cause. The following table lists some hypothetical symptoms and corresponding causes.
