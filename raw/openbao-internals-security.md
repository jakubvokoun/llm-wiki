---
source_url: https://openbao.org/docs/internals/security/
fetched: 2026-07-03
---
...
[unseal challenge](/docs/concepts/integrated-storage/#openbao-networking-recap).
...
Secret Sharing
technique](https://en.wikipedia.org/wiki/Shamir%27s_Secret_Sharing). When OpenBao
is started, it starts in a *sealed* state. This means that the encryption key
