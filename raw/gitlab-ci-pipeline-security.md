...
HashiCorp's Vault, Azure Key Vault, and Google Cloud Secret Manager.
...
* Are stored in the GitLab project, group, or instance settings. Users with access
  to the settings have access to variables values that are not hidden.
...
* Use protected container repositories to restrict which users can make changes to container images.
* Use protected tags to control who can push and delete container tags.
