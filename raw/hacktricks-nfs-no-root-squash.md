...
[2049 - Pentesting NFS Service](../../network-services-pentesting/nfs-service-pentesting.html)
...
* **Mounting that directory** in a client machine, and **as root copying** inside the mounted folder our come compiled payload that will abuse the SUID permission, give to it **SUID** rights, and **execute from the victim** machine that binary (you can find here some [C SUID payloads](payloads-to-execute.html#c)).
