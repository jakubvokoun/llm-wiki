...
This ruleset is not intended as a complete replacement for [rules_docker](https://github.com/bazelbuild/rules_docker).
...
* [C/C++](https://github.com/bazel-contrib/rules_oci/blob/main/docs/cpp.md)
* [Go](https://github.com/bazel-contrib/rules_oci/blob/main/docs/go.md)
* [Java](https://github.com/bazel-contrib/rules_oci/blob/main/docs/java.md)
* [JavaScript](https://github.com/bazel-contrib/rules_oci/blob/main/docs/javascript.md)
* [Python](https://github.com/bazel-contrib/rules_oci/blob/main/docs/python.md)
* [Rust](https://github.com/bazel-contrib/rules_oci/blob/main/docs/rust.md)
* [Scala](https://github.com/bazel-contrib/rules_oci/blob/main/docs/scala.md)
* [WASM](https://github.com/bazel-contrib/rules_oci/tree/main/e2e/wasm) (see https://docs.docker.com/desktop/wasm/)
* [Static Content](https://github.com/bazel-contrib/rules_oci/blob/main/docs/static_content.md) (such as a html/javascript frontend)
...
* [oci_image](https://github.com/bazel-contrib/rules_oci/blob/main/docs/image.md) Build an OCI compatible container image.
* [oci_image_index](https://github.com/bazel-contrib/rules_oci/blob/main/docs/image_index.md) Build a multi-architecture OCI compatible container image.
* [oci_load](https://github.com/bazel-contrib/rules_oci/blob/main/docs/load.md) Loads an `oci_image` into a container daemon. Can optionally produce a loadable tarball.

### Pull and Push

* [oci_pull](https://github.com/bazel-contrib/rules_oci/blob/main/docs/pull.md) Pull image layers using Bazel's downloader. Falls back to using `curl` in some cases.
* [oci_push](https://github.com/bazel-contrib/rules_oci/blob/main/docs/push.md) Push an `oci_image` or `oci_image_index` to a remote registry.
