...
The file located in `/proc/sys/fs/binfmt_misc` indicates which binary should execute which type of files. TODO: check the requirements to abuse this to execute a rev shell when a common file type is open.
