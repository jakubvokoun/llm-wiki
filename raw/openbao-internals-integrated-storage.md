---
source_url: https://openbao.org/docs/internals/integrated-storage/
fetched: 2026-07-03
---
...
protocol](https://en.wikipedia.org/wiki/Consensus_%28computer_science%29) to provide
...
are blocked until they are *committed* and *applied*.
...
[initialized](/docs/commands/operator/init/). At this point, the
