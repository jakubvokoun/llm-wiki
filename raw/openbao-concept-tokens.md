---
source_url: https://openbao.org/docs/concepts/tokens/
fetched: 2026-07-03
---

# Tokens

Internal token structure is volatile
...
Tokens are the core method for *authentication* within OpenBao. Tokens
...
* The *body* is a randomly-generated 24 or more characters
...
tokens can do anything in OpenBao. *Anything*. In addition, they are the only
...
3. By using `bao operator generate-root`
...
* When a periodic token is created via a token store role, the *current* value
