---
source_url: https://openbao.org/docs/concepts/namespaces/
fetched: 2026-07-03
---
...
Refer to the [Namespace limits section](/docs/internals/limits/#namespace-limits)
of [OpenBao limits and maximums](/docs/internals/limits/) for storage limits
...
[`namespace`](/docs/commands/namespace/) CLI command to manage
your namespaces.
...
The following paths are restricted:
