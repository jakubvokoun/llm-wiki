---
source_url: https://docs.tilt.dev/personal_registry.html
fetched: 2026-07-01
---
...
* If you're using a local cluster like Kind, our setup
  scripts will set up a registry for you.
...
`ttl.sh` is an anonymous, ephemeral image registry that you can use for development.
It's operated by our friends at Replicated.
...
repository ahead of time for each image name.
...
cloud non-providers like Replicated's ttl.sh above).

If you're struggling to set up and authenticate to a registry, come talk to
us and a support engineer will point you in the right direction.
