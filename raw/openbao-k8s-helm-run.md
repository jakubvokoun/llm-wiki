---
source_url: https://openbao.org/docs/platform/k8s/helm/run/
fetched: 2026-07-03
---
...
configuration value](/docs/configuration/#ui).
...
*Single Tenancy.* OpenBao should be the only main process running on a machine.
...
*Immutable Upgrades.* OpenBao relies on an external storage backend for persistence,
...
*Upgrade Frequently.* OpenBao is actively developed, and updating frequently is
...
*Restrict Storage Access.* OpenBao encrypts all data at rest, regardless of which
