---
source_url: https://docs.tilt.dev/tiltfile_config.html
fetched: 2026-07-01
---
...
then you do *not* specify the flag and all positional arguments will be merged into a list (`tilt up -- bar baz`).
