...
The full list of enforced policies, including which are mutations vs. validations and any configuration options, is documented in the Policy Engine reference.
