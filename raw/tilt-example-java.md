---
source_url: https://docs.tilt.dev/example_java.html
fetched: 2026-07-01
---
...
[Recommended Setup](https://github.com/tilt-dev/tilt-example-java/blob/master/4-recommended)
...
[![](assets/docimg/example-java-image-1.png "The server is up!")](https://cloud.tilt.dev/snapshot/AfbdiucLHi33cqQwrG4%3D)
...
[![](assets/docimg/example-java-image-2.png "Result of clicking the button on the 'deploy' resource.")](https://cloud.tilt.dev/snapshot/AeDqiucLr-00XLJpiWc%3D)

Clicking the button triggers the 'deploy' local\_resource, which in turn kicks off an update to the server. (Click the screenshot to see an interactive view.)

| Approach | Deploy Time[1](#fn:1) |
| --- | --- |
| Naive | 87.7s |
...
[![](assets/docimg/example-java-image-3.png "Step 2 complete.")](https://cloud.tilt.dev/snapshot/AabuiucL7NKgfiTa1uI%3D)

Step 2 complete. (Click the screenshot to see an interactive snapshot.)
...
[![](assets/docimg/example-java-image-4.png "Step 3 complete.")](https://cloud.tilt.dev/snapshot/AcaQnucLOBUS4TGQauw%3D)

Step 3 complete. (Click the screenshot to see an interactive snapshot.)
...
Tilt's live\_update will copy any files that have been touched.
...
[![](assets/docimg/example-java-image-5.png "Tilt state after a live_update.")](https://cloud.tilt.dev/snapshot/AeKPnucLESM6hHyx8HY%3D)

The result of a live\_update. (Click the screenshot to see an interactive view.)
...
| Local Compile | 13.4s |
| Optimized Dockerfile | 6.5s |
| With live\_update | 4.8s |

You can try the server here:

[Recommended Structure](https://github.com/tilt-dev/tilt-example-java/blob/master/4-recommended)
...
but we've had mixed results using this with live\_update.
...
1. Tilt's first deployment of a service takes a few seconds longer than subsequent ones, due to some behind-the-scenes setup. Measurements in this guide focus on non-initial builds. [↩](#fnref:1)
