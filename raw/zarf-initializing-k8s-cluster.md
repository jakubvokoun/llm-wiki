...
**Note:** More information about the init-package and its components can be found [here](/ref/init-package/)

**Note:** You will only be prompted to deploy the k3s component if you are on a Linux machine
