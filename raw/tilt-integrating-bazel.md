---
source_url: https://docs.tilt.dev/integrating_bazel_with_tilt.html
fetched: 2026-07-01
---
...
*Note: Before diving in to this guide you should have run through [Tilt's Getting Started Guide](/tutorial) and the deep dive in to [Tiltfile concepts](tiltfile_concepts.html). A familiarity with the Bazel build system will also clear a lot of things up but isn't necessary. Ready? Let's get started!*
