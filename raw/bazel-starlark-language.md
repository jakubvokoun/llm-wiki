...
* [bool](/rules/lib/bool)
* [dict](/rules/lib/dict)
* [tuple](/rules/lib/tuple)
* [function](/rules/lib/function)
* [int](/rules/lib/int)
* [list](/rules/lib/list)
* [string](/rules/lib/string)
...
[lists](/rules/lib/list) and [dicts](/rules/lib/dict). Changes to mutable
...
* `class` (see [`struct`](/rules/lib/struct#struct) function).
