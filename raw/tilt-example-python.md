---
source_url: https://docs.tilt.dev/example_python.html
fetched: 2026-07-01
---
...
[Recommended Setup](https://github.com/tilt-dev/tilt-example-python/blob/master/3-recommended)
...
[![](assets/docimg/example-python-0-base.png "The server is up!")](https://cloud.tilt.dev/snapshot/AcTG0ucLlISGcy3NXSU%3D)
...
[![](assets/docimg/example-python-1-measured.png "Result of clicking the button on the 'deploy' resource.")](https://cloud.tilt.dev/snapshot/AeTJ0ucLJor0hnfdg7s%3D)
...
[![](assets/docimg/example-python-2-dockerfile.png "A Docker build making good use of caching.")](https://cloud.tilt.dev/snapshot/AZjdiecL6XcZBu5kO3Y%3D)
...
[![](assets/docimg/example-python-3-liveupdate.png "Tilt state after a live_update.")](https://cloud.tilt.dev/snapshot/AfLO0ucLqMHzz2JA5ls%3D)
...
[Recommended Structure](https://github.com/tilt-dev/tilt-example-python/blob/master/3-recommended)
