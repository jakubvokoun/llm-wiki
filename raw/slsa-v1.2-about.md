...
Building off the analogy of "ingredient labels" for software (SBOMs), SLSA can be thought of as all the food
...
easier to adopt, but with only modest security guarantees. Currently, the
SLSA Build Track encompasses Levels 1 through 3.
