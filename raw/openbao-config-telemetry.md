---
source_url: https://openbao.org/docs/configuration/telemetry/
fetched: 2026-07-03
---
...
endpoint on standby nodes by [enabling unauthenticated metrics access](/docs/configuration/listener/tcp/#telemetry-parameters).
