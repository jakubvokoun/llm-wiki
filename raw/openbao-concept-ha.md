---
source_url: https://openbao.org/docs/concepts/ha/
fetched: 2026-07-03
---
...
[Configuration](/docs/configuration/storage/) page.
...
[`cluster_address`](/docs/configuration/listener/tcp/#cluster_address) values set in the
...
include the [Integrated Storage](/docs/configuration/storage/raft/) and
[PostgreSQL](/docs/configuration/storage/postgresql/) backends. In addition to
...
page](/docs/configuration/storage/) should be referenced.
...
[comparison
chart](/docs/configuration/storage/#integrated-storage-raft-vs-postgresql)
