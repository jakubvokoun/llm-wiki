...
Published June 30, 2015 | Read time: 8m

![Monitoring 101: Alerting on what matters](https://blog.dd-static.net/img/blog/monitoring-101-alerting/monitoring101-blog-2.png?auto=compress%2Cformat&cs=origin&lossless=true&fit=crop&disable=upscale&q=75&ar=380%3A193&w=1400&h=711&dpr=1)

## Series Context

This article is part of a series on effective monitoring. Related parts:
- Part 1: [Monitoring 101: Collecting the right data](/blog/monitoring-101-collecting-data/)
- Part 3: [Monitoring 101: Investigating performance issues](/blog/monitoring-101-investigation/)
...
#### Question 2: Does this issue require attention?
...
#### Question 3: Is this issue urgent?
...
*This article is part of the Monitoring 101 series and draws on experience monitoring large-scale infrastructure and work from leading monitoring experts in the field.*
