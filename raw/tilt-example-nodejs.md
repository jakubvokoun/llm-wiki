---
source_url: https://docs.tilt.dev/example_nodejs.html
fetched: 2026-07-01
---
...
[Recommended Setup](https://github.com/tilt-dev/tilt-example-nodejs/tree/master/3-recommended)
...
[![](assets/docimg/example-nodejs-0-base.png "The server is up!")](https://cloud.tilt.dev/snapshot/AaCZ3OcLBq71xO1QuQo%3D)
...
[![](assets/docimg/example-nodejs-1-measured.png "Result of clicking the button on the 'deploy' resource.")](https://cloud.tilt.dev/snapshot/AaSV3OcLJGqj-U_V8Tg%3D)
...
[![](assets/docimg/example-nodejs-2-dockerfile.png "A Docker build making good use of caching.")](https://cloud.tilt.dev/snapshot/AZ6a3OcLaxcONn6KqF8%3D)

Dependency installation now uses the cache instead of actually running a long, slow command. (Click the screenshot to see an interactive view.)
...
[![](assets/docimg/example-nodejs-3-liveupdate.png "Tilt state after a live_update.")](https://cloud.tilt.dev/snapshot/AYqb3OcLW4OITnmpIAE%3D)
...
| Naive | 11.31-14.21s |
| Optimized Dockerfile | 3.25-4.12s |
| With live\_update | 1.1-1.8s |

You can try the server here:

[Recommended Structure](https://github.com/tilt-dev/tilt-example-nodejs/blob/master/3-recommended)
