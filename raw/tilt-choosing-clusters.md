---
source_url: https://docs.tilt.dev/choosing_clusters.html
fetched: 2026-07-01
---
...
* The least widely used. That's not *necessarily* bad. Just be aware that
...
### (EKS, AKS, GKE, and [custom clusters](https://medium.com/%40cfatechblog/bare-metal-k8s-clustering-at-chick-fil-a-scale-7b0607bd3541))
...
using [allow
\_k8s\_contexts](api.html#api.allow_k8s_contexts):
