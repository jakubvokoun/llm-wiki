...
[SANS Blog - Escaping restricted Linux shells](https://pen-testing.sans.org/blog/2012/06/06/escaping-restricted-linux-shells)

[GTFOBins](https://gtfobins.github.io)

See also: [Bypass Linux Restrictions](../bypass-bash-restrictions/index.html)

## Python Jails

Tricks about escaping from python jails in the following page: [Bypass Python sandboxes](../../generic-methodologies-and-resources/python/bypass-python-sandboxes/index.html)
...
* https://www.youtube.com/watch?v=UO618TeyCWo
