...
There's also a currently-experimental state overlay service
...
Together, this will have the semantic that on OS updates, on the next boot (early in boot), any new files/directories will be copied. For more information on this, see the tmpfiles.d man page.
