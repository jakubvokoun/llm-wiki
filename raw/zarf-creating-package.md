...
## [Putting Together a Zarf Package](#putting-together-a-zarf-package)
...
### [Creating the Package Definition](#creating-the-package-definition)
...
### [Adding the WordPress Component](#adding-the-wordpress-component)
...
### [Finding the Images](#finding-the-images)
...
### [Setting up a Zarf Connect Service](#setting-up-a-zarf-connect-service)
...
### [Unable to read zarf.yaml file](#unable-to-read-zarfyaml-file)
