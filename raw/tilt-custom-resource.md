---
source_url: https://docs.tilt.dev/custom_resource.html
fetched: 2026-07-01
---
...
See the [k8s\_kind API docs](api.html#k8s_kind) for more detail, or look at [this
...
See the [k8s\_resource API docs](api.html#k8s_resource) for more detail, or look
at [this
...
Tilt built. (The custom\_build guide has [more
