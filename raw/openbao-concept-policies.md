---
source_url: https://openbao.org/docs/concepts/policies/
fetched: 2026-07-03
---
...
## Policy-authorization workflow[​](#policy-authorization-workflow "Direct link to Policy-authorization workflow")
...
![OpenBao Auth Workflow](/assets/images/openbao-policy-workflow-eb8a3c549e9e9a7f1aa9a7a34290582f.png)
...
3. The policy's contents are uploaded and stored in OpenBao and referenced by name.
...
![OpenBao Auth Workflow](/assets/images/openbao-auth-workflow-cfa532248968cdd9f3fd16e8c02c1b49.png)
...
## Policy syntax[​](#policy-syntax "Direct link to Policy syntax")

Policies are written in [HCL](https://github.com/hashicorp/hcl) or JSON and describe which paths in OpenBao a
...
asterisk (`*`). It *is not a regular expression* and is only supported **as the
...
* `scan` (`SCAN`) - Allows recursively listing ("scanning") values at the
  given path. Note that the keys returned by a `list` operation are *not*
...
* `sudo`  - Allows access to paths that are *root-protected*. Tokens are not
...
## Templated policies[​](#templated-policies "Direct link to Templated policies")
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Name Description|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.entity.id` The entity's ID|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.entity.name` The entity's name|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.entity.metadata.<metadata key>` Metadata associated with the entity for the given key|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.entity.aliases.<mount accessor>.id` Entity alias ID for the given mount|  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.entity.aliases.<mount accessor>.name` Entity alias name for the given mount|  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.entity.aliases.<mount accessor>.metadata.<metadata key>` Metadata associated with the alias for the given mount and metadata key|  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.entity.aliases.<mount accessor>.custom_metadata.<custom_metadata key>` Custom metadata associated with the alias for the given mount and custom metadata key|  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | | `identity.groups.ids.<group id>.name` The group name for the given group ID|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | `identity.groups.names.<group name>.id` The group ID for the given group name|  |  |  |  | | --- | --- | --- | --- | | `identity.groups.ids.<group id>.metadata.<metadata key>` Metadata associated with the group for the given key|  |  | | --- | --- | | `identity.groups.names.<group name>.metadata.<metadata key>` Metadata associated with the group for the given key | | | | | | | | | | | | | | | | | | | | | | | |
...
### Path expiration[​](#path-expiration "Direct link to Path expiration")
...
#### Parameter constraints limitations[​](#parameter-constraints-limitations "Direct link to Parameter constraints limitations")
...
##### Globbing[​](#globbing "Direct link to Globbing")
...
##### Limiting pagination[​](#limiting-pagination "Direct link to Limiting pagination")
...
##### Filtering list or scan results[​](#filtering-list-or-scan-results "Direct link to Filtering list or scan results")
...
### Required response wrapping TTLs[​](#required-response-wrapping-ttls "Direct link to Required response wrapping TTLs")
...
### Default policy[​](#default-policy "Direct link to Default policy")
...
### Root policy[​](#root-policy "Direct link to Root policy")
...
*anything* within OpenBao. As such, it is **highly recommended** that you revoke
...
## Managing policies[​](#managing-policies "Direct link to Managing policies")
...
### Listing policies[​](#listing-policies "Direct link to Listing policies")
...
### Creating policies[​](#creating-policies "Direct link to Creating policies")
...
### Updating policies[​](#updating-policies "Direct link to Updating policies")
...
### Deleting policies[​](#deleting-policies "Direct link to Deleting policies")
...
## Associating policies[​](#associating-policies "Direct link to Associating policies")
...
## Root protected API endpoints[​](#root-protected-api-endpoints "Direct link to Root protected API endpoints")
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Path HTTP verb Description|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [auth/token/accessors](/api-docs/auth/token/#list-accessors) LIST List token accessors for all current OpenBao service tokens|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [auth/token/create](/api-docs/auth/token/#create-token) POST Create a periodic or an orphan token (`period` or `no_parent`) option| [pki/root](/api-docs/secret/pki/#delete-all-issuers-and-keys) DELETE Delete the current CA key ([pki secrets engine](/docs/secrets/pki/))| [pki/root/sign-self-issued](/api-docs/secret/pki/#sign-self-issued) POST Use the configured CA certificate to sign a self-issued certificate ([pki secrets engine](/docs/secrets/pki/))| [sys/audit](/api-docs/system/audit/) GET List enabled audit devices|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/audit/:path](/api-docs/system/audit/) POST, DELETE Enable or remove an audit device|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/auth/:path](/api-docs/system/auth/) GET, POST, DELETE Manage the auth methods (enable, read, and delete)|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/auth/:path/tune](/api-docs/system/auth/#tune-auth-method) GET, POST Manage the auth methods (enable, read, delete, and tune)|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/config/auditing/request-headers](/api-docs/system/config-auditing/) GET List the request headers that are configured to be audited|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/config/auditing/request-headers/:name](/api-docs/system/config-auditing/) GET, POST, DELETE Manage the auditing headers (create, update, read and delete)|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/config/cors](/api-docs/system/config-cors/) GET, POST, DELETE Configure CORS setting|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/config/ui/headers](/api-docs/system/config-ui/) GET, LIST Configure the UI settings|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/config/ui/headers/:name](/api-docs/system/config-ui/#name) POST, DELETE Configure custom HTTP headers to be served with the UI|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/internal/inspect/router/:tag](/api-docs/system/inspect/router/) GET Inspect the internal components of OpenBao's router. `tag` must be one of root, uuid, accessor, or storage| [sys/leases/lookup/:prefix](/api-docs/system/leases/#list-leases) LIST List lease IDs|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/leases/revoke-force/:prefix](/api-docs/system/leases/#revoke-force) POST Revoke all secrets or tokens ignoring backend errors|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/leases/revoke-prefix/:prefix](/api-docs/system/leases/#revoke-prefix) POST Revoke all secrets generated under a given prefix|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/plugins/catalog/:type/:name](/api-docs/system/plugins-catalog/#register-plugin) GET, POST, DELETE Register a new plugin, or read/remove an existing plugin|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/raw:path](/api-docs/system/raw/) GET, POST, DELETE Used to access the raw underlying store in OpenBao|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/raw:prefix](/api-docs/system/raw/#list-raw) GET, LIST Returns a list keys for a given path prefix|  |  |  |  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/remount](/api-docs/system/remount/) POST Moves an already-mounted backend to a new mount point|  |  |  |  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | --- | --- | --- | | [sys/rotate](/api-docs/system/rotate/) POST Trigger a rotation of the backend encryption key|  |  |  |  |  |  | | --- | --- | --- | --- | --- | --- | | [sys/seal](/api-docs/system/seal/) POST Seals the OpenBao|  |  |  | | --- | --- | --- | | [sys/step-down](/api-docs/system/step-down/) POST Forces a node to give up active status | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
