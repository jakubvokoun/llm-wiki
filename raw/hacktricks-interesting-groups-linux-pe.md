...
Finally, if you don't like any of the suggestions of before, or they aren't working for some reason (docker api firewall?) you could always try to **run a privileged container and escape from it**.

If you have write permissions over the docker socket you could escalate privileges abusing the docker socket.

## lxc/lxd Group

Similar privilege escalation vectors exist for lxc/lxd group membership.
