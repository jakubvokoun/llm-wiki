...
templates](/docs/visualization/consoles/). The `$labels`
...
[Alertmanager](/docs/alerting/alertmanager/) takes on this
...
Prometheus can be [configured](/docs/prometheus/latest/configuration/configuration/) to automatically discover available
