---
source_url: https://docs.tilt.dev/example_static_html.html
fetched: 2026-07-01
---
...
[tilt-example-html](https://github.com/tilt-dev/tilt-example-html)

To skip straight to the fully optimized setup, go to this subdirectory:

[Recommended Setup](https://github.com/tilt-dev/tilt-example-html/blob/master/2-recommended)
...
[![](assets/docimg/example-static-html-image-1.png "The server is up!")](https://cloud.tilt.dev/snapshot/AejkyuULr2AjWu50Eck%3D)
...
[![](assets/docimg/example-static-html-image-2.png "Result of clicking the button on the 'deploy' resource.")](https://cloud.tilt.dev/snapshot/AcD7yuUL6_d3neimWHk%3D)
...
[![](assets/docimg/example-static-html-image-3.png "Tilt state after a live_update")](https://cloud.tilt.dev/snapshot/AZik6-ULEyDHLV-ILmY%3D)
...
| --- | --- |
| Naive | 1-2s |
| With live\_update | 0-1s |

You can try the server here:

[Recommended Structure](https://github.com/tilt-dev/tilt-example-html/blob/master/2-recommended)
