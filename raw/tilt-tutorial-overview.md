---
source_url: https://docs.tilt.dev/tutorial/index.html
fetched: 2026-07-01
---
...
Throughout the tutorial, we'll refer to the [`tilt-avatars`](https://github.com/tilt-dev/tilt-avatars) project.
The full source is available on [GitHub](https://github.com/tilt-dev/tilt-avatars) to refer to or checkout locally to follow along interactively.
...
5. **Smart Rebuilds with Live Update**
   ...
   The only downside is you won't have time for [office sword fights](https://xkcd.com/303/) anymore.
