...
* openSUSE Atomic
  ...
  + [openSUSE Kalpa](https://en.opensuse.org/Portal%3AKalpa) - An atomic variant of openSUSE with the KDE Plasma desktop environment, featuring containers with Distrobox.
