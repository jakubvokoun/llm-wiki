...
Learn about Chainguard Containers, distroless images, and how they provide enhanced security through minimal attack surface and comprehensive supply chain features.
...
By default, all Wolfi-based images are built for x86\_64 (also known as AMD64) and AArch64 (also known as ARM64) architecture with the following CPU Instruction Set Architecture (ISA) baseline features:

* x86\_64: x86-64-v2 (Sapphire Rapids)
