---
source_url: https://docs.tilt.dev/buttons.html
fetched: 2026-07-01
---
...
The simplest way to do this is via the [uibutton extension](https://github.com/tilt-dev/tilt-extensions/blob/master/uibutton/README.md).

This page focuses on conveying general functionality. More complex use cases can create buttons directly via Tilt's API – one good example is the [cancel extension](https://github.com/tilt-dev/tilt-extensions/blob/master/cancel/README.md). For usage specifics, refer to the [uibutton docs](https://github.com/tilt-dev/tilt-extensions/blob/master/uibutton/README.md).
...
2. Your project has a script that can be a bit risky / expensive and sometimes
   ...
   ![](assets/img/button-example-dry-run.png)
...
More information can be found in the [uibutton docs](https://github.com/tilt-dev/tilt-extensions/blob/master/uibutton/README.md).
