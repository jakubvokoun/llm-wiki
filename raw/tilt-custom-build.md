---
source_url: https://docs.tilt.dev/custom_build.html
fetched: 2026-07-01
---
...
[rules\_docker](https://github.com/bazelbuild/rules_docker) extension assembles
...
way to get the deploy tag at runtime. So they hack custom\_build to grab the
...
The `ignore` parameter takes a pattern or list of patterns (following [`.dockerignore` syntax](https://docs.docker.com/engine/reference/builder/#dockerignore-file); files matching any of these patterns will *not* trigger a build.
