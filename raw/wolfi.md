...
Named after the [smallest octopus](https://en.wikipedia.org/wiki/Octopus_wolfi), [Wolfi](https://wolfi.dev) is a lightweight GNU software distribution which is designed around minimalism, making it well-suited for containerized environments built with [apko](https://github.com/chainguard-dev/apko).

It is built using [melange](https://github.com/chainguard-dev/melange), and is sponsored by [Chainguard](https://chainguard.dev/), which uses it to provide [lightweight GNU/Linux runtime images](https://chainguard.dev/chainguard-images).
...
A full guide is available on the [org page](https://github.com/wolfi-dev), but the quickest way to try out Wolfi is with the [wolfi-base image](https://github.com/chainguard-images/images/tree/main/images/wolfi-base):
