---
source_url: https://openbao.org/docs/configuration/storage/raft/
fetched: 2026-07-03
---
...
* `retry_join_as_non_voter` `(boolean: false)`  - If set, causes any `retry_join`
  ...
  [`-non-voter`](/docs/commands/operator/raft/#_non_voter) flag for the
