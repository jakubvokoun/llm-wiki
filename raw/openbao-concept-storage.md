---
source_url: https://openbao.org/docs/concepts/storage/
fetched: 2026-07-03
---
...
storage](/docs/configuration/storage/#integrated-storage-raft-vs-postgresql)
...
Backups *can* also help with accidental data deletions or modifications. In
...
chart](https://github.com/openbao/openbao-helm). Find an example [here](/docs/platform/k8s/helm/examples/snapshot-cronjob/).
